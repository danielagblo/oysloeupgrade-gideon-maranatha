...
export const User = z
  .object({
    ...
    referralCode: z
      ...
      .max(20)
      .optional()
      .describe("User referral code"),
    referralPoints: z
      .number()
      .int()
      .min(0)
      .default(0)
      .describe("User referral points"),
    ...
    isSuperuser: z
      .boolean()
      .default(false)
      .describe("Whether user is superuser"),
    phoneVerified: z
      .boolean()
      .default(false)
      .describe("Whether phone is verified"),
    emailVerified: z
      .boolean()
      .default(false)
    ...
    createdFromApp: z
      .boolean()
      .default(true)
      .describe("Whether user was created from app"),
    lastLogin: z
      .string()
      .datetime()
      .optional()
