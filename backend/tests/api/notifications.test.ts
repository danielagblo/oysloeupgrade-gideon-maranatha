...
describe('Notifications API', () => {
  ...
  describe('GET /api-v1/notifications/history', () => {
    ...
    it('supports pagination', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/notifications/history?page=1&limit=2`, {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    it('supports unread filter', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/notifications/history?unreadOnly=true`, {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  describe('PUT /api-v1/notifications/:id/read', () => {
    it('marks notification as read', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/notifications/${n.id}/read`, {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${token}`,
        },
      ...
      const unreadResp = await fetch(`${baseURL}/api-v1/notifications/unread-count`, {
        method: 'GET',
    ...
    it('rejects mark as read without authentication', async () => {
      const response = await fetch(`${baseURL}/api-v1/notifications/test-id/read`, {
        method: 'PUT',
      });
    ...
    it('validates notification ID format', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/notifications/invalid-id/read`, {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${token}`,
        },
