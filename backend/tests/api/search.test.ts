...
describe('Search API', () => {
  ...
  describe('GET /api-v1/search/enhanced', () => {
    it('returns empty results when no products match', async () => {
      const response = await fetch(`${baseURL}/api-v1/search/enhanced?q=nonexistent`);
    ...
    it('searches products by name', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/search/enhanced?q=iPhone`);
    ...
    it('searches products by description', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/search/enhanced?q=wireless`);
    ...
    it('supports pagination', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/search/enhanced?q=Product&page=1&limit=2`);
  ...
  describe('GET /api-v1/search/suggestions', () => {
    it('returns empty suggestions when no products exist', async () => {
      const response = await fetch(`${baseURL}/api-v1/search/suggestions?q=test`);
    ...
    it('returns search suggestions', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/search/suggestions?q=iPhone`);
    ...
    it('limits suggestions count', async () => {
      ...
      const response = await fetch(`${baseURL}/api-v1/search/suggestions?q=Product&limit=5`);
